...
module.exports = __webpack_require__(/*! C:\projeto\ionic\app01\src\main.ts */"zUnb");
...
const environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyD-s7bq5-siWZSDfbSiI6QuV46_syMjHVc",
        authDomain: "app01-3ffb9.firebaseapp.com",
        projectId: "app01-3ffb9",
        storageBucket: "app01-3ffb9.appspot.com",
        messagingSenderId: "799947836224",
        appId: "1:799947836224:web:e61dedcdb0e0fa559b08a5"
    }
};
/*
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app>\r\n  <ion-split-pane contentId=\"main-content\">\r\n    <ion-menu contentId=\"main-content\" type=\"overlay\">\r\n      <ion-content>\r\n        <ion-list id=\"inbox-list\">\r\n\r\n          <ion-list-header>Fuinhas</ion-list-header>\r\n          <ion-note>Futucando onde não deve.</ion-note>\r\n\r\n          <ion-menu-toggle auto-hide=\"false\">\r\n            <ion-item routerDirection=\"root\" routerLink=\"/articles\" lines=\"none\" detail=\"false\"\r\n              routerLinkActive=\"selected\">\r\n              <ion-icon slot=\"start\" name=\"document-text\"></ion-icon>\r\n              <ion-label>Artigos</ion-label>\r\n            </ion-item>\r\n          </ion-menu-toggle>\r\n\r\n          <ion-menu-toggle auto-hide=\"false\">\r\n            <ion-item routerDirection=\"root\" routerLink=\"/news\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\r\n              <ion-icon slot=\"start\" name=\"newspaper\"></ion-icon>\r\n              <ion-label>Notícias</ion-label>\r\n            </ion-item>\r\n          </ion-menu-toggle>\r\n\r\n          <ion-menu-toggle auto-hide=\"false\">\r\n            <ion-item routerDirection=\"root\" routerLink=\"/contacts\" lines=\"none\" detail=\"false\"\r\n              routerLinkActive=\"selected\">\r\n              <ion-icon slot=\"start\" name=\"chatbubbles\"></ion-icon>\r\n              <ion-label>Faça Contato</ion-label>\r\n            </ion-item>\r\n          </ion-menu-toggle>\r\n\r\n          <ion-menu-toggle auto-hide=\"false\">\r\n            <ion-item routerDirection=\"root\" routerLink=\"/about\" lines=\"none\" detail=\"false\"\r\n              routerLinkActive=\"selected\">\r\n              <ion-icon slot=\"start\" name=\"information-circle\"></ion-icon>\r\n              <ion-label>Sobre</ion-label>\r\n            </ion-item>\r\n          </ion-menu-toggle>\r\n\r\n        </ion-list>\r\n\r\n        <ion-list>\r\n\r\n          <!-- Se tem usuário logado -->\r\n\r\n          <div *ngIf=\"auth.user | async as user; else showLogin\">\r\n\r\n            <ion-menu-toggle auto-hide=\"false\">\r\n\r\n              <ion-item routerDirection=\"root\" routerLink=\"/user/profile\" lines=\"none\" detail=\"false\"\r\n              routerLinkActive=\"selected\">\r\n              <ion-avatar slot=\"start\">\r\n                <ion-img src=\"{{ user.photoURL }}\" alt=\"Ver perfil de {{ user.displayName }}\"></ion-img>\r\n              </ion-avatar>\r\n              <ion-label>\r\n                {{ user.displayName }}\r\n                <div><small>{{ user.email }}</small></div>                \r\n              </ion-label>\r\n            </ion-item>\r\n\r\n            </ion-menu-toggle>\r\n\r\n          </div>\r\n\r\n          <!-- Mostra login se usuário não está logado -->\r\n          <ng-template #showLogin>\r\n\r\n            <ion-menu-toggle auto-hide=\"false\">\r\n\r\n              <ion-item routerDirection=\"root\" routerLink=\"/user/login\" lines=\"none\" detail=\"false\"\r\n                routerLinkActive=\"selected\">\r\n                <ion-avatar slot=\"start\">\r\n                  <ion-img src=\"assets/user.png\" alt=\"Faça login\"></ion-img>\r\n                </ion-avatar>\r\n                <ion-label>Entrar / Login</ion-label>\r\n              </ion-item>\r\n\r\n            </ion-menu-toggle>\r\n\r\n          </ng-template>\r\n\r\n        </ion-list>\r\n\r\n      </ion-content>\r\n\r\n      <div class=\"ion-text-center ion-padding\">\r\n        <small>&copy; Copyright 2021 André Luferat</small>\r\n      </div>\r\n\r\n    </ion-menu>\r\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\r\n  </ion-split-pane>\r\n</ion-app>");
...
const toLogin = () => Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectUnauthorizedTo"])(['/user/login']);
// Usuário está logado? Vai para a página inicial.
const isLogged = () => Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectLoggedInTo"])(['/articles']);
const routes = [
    ...
    {
        path: 'articles',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-articles-articles-module */ "pages-articles-articles-module").then(__webpack_require__.bind(null, /*! ./pages/articles/articles.module */ "BAW5")).then(m => m.ArticlesPageModule)
    },
    {
        path: 'news',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-news-news-module */ "pages-news-news-module").then(__webpack_require__.bind(null, /*! ./pages/news/news.module */ "qUUn")).then(m => m.NewsPageModule)
    },
    {
        path: 'contacts',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-contacts-contacts-module */ "pages-contacts-contacts-module").then(__webpack_require__.bind(null, /*! ./pages/contacts/contacts.module */ "EWb5")).then(m => m.ContactsPageModule)
    },
    {
        path: 'about',
    ...
    {
        path: 'view/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-view-view-module */ "pages-view-view-module").then(__webpack_require__.bind(null, /*! ./pages/view/view.module */ "UKpm")).then(m => m.ViewPageModule),
        // Só pode ser vista se logado
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]], data: { authGuardPipe: toLogin }
    },
    {
        path: 'user/login',
        loadChildren: () => __webpack_require__.e(/*! import() | user-login-login-module */ "user-login-login-module").then(__webpack_require__.bind(null, /*! ./user/login/login.module */ "EhU7")).then(m => m.LoginPageModule),
        // Só pode ser vista se não logado
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]], data: { authGuardPipe: isLogged }
    },
    {
        path: 'user/logout',
        loadChildren: () => __webpack_require__.e(/*! import() | user-logout-logout-module */ "user-logout-logout-module").then(__webpack_require__.bind(null, /*! ./user/logout/logout.module */ "fsJ+")).then(m => m.LogoutPageModule),
        // Só pode ser vista se logado
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]], data: { authGuardPipe: toLogin }
    },
    {
        path: 'user/profile',
        loadChildren: () => __webpack_require__.e(/*! import() | user-profile-profile-module */ "user-profile-profile-module").then(__webpack_require__.bind(null, /*! ./user/profile/profile.module */ "HKqj")).then(m => m.ProfilePageModule),
        // Só pode ser vista se logado
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]], data: { authGuardPipe: toLogin }
    },
    // Página de erro 404
    ...
    {
        path: '**',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-e404-e404-module */ "pages-e404-e404-module").then(__webpack_require__.bind(null, /*! ./pages/e404/e404.module */ "QPNz")).then(m => m.E404PageModule)
    }
];
